...
if __name__=="__main__":
    save_dir = "gan_generator/outputs/conv_med_dlr_gan_cifar10_output"
    stats_df = pd.read_csv("gan_generator/outputs/conv_med_dlr_gan_cifar10_output/training_stats.csv")
